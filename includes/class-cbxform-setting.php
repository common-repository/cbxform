 ...
 * Further modified by wpboxr.com team
 *
 * Futher modification by wpboxr.com team
 */
if ( !class_exists( 'CBXForm_Settings_API' ) ):
class CBXForm_Settings_API {
    ...
    function callback_title($args) {
        ...
        //var_dump($args);
        //$html = sprintf('<td colspan="2"><h3> %s</h3></td>', $args['name']);
        //echo $html;
			...
			<?php foreach ( $this->settings_sections as $form ) {?>
				<div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
					<form method="post" action="options.php">
						<?php
						do_action( 'cbxform_setting_top_' . $form['id'], $form );
						settings_fields( $form['id'] );
						do_settings_sections( $form['id'] );
						do_action( 'cbxform_setting_bottom_' . $form['id'], $form );
						?>
