...
<div id="postbox-container-1" class="postbox-container">
    <div class="meta-box-sortables">
        ...
        <div class="postbox">
            <h3><?php _e('Help & Supports', 'cbxform'); ?></h3>
            <div class="inside">
        ...
        <div class="postbox">
            <h3><?php _e('Codeboxr Updates', 'cbxform'); ?></h3>
            <div class="inside">
                <?php
        ...
        <div class="postbox">
        <h3><?php _e('Other Wordpress Plugins', 'cbxform'); ?></h3>
        <div class="inside">
            <?php
            include_once(ABSPATH . WPINC . '/feed.php');
            if (function_exists('fetch_feed')) {
        ...
        <div class="postbox">
            <h3><?php _e('Codeboxr on facebook', 'cbxform') ?></h3>
            <div class="inside">
                <iframe
